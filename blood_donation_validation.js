...
function validateBloodDonationEligibility(age, weight, height) {
    ...
    var isEligible = validateAge(age) && validateWeight(weight) && validateHeight(height) && bmi >= 18.5 && bmi <= 30;
    return isEligible;
}
...
function validateForm() {
    ...
    var isEligible = validateBloodDonationEligibility(age, weight, height);
    if (!isEligible) {
